...
class HostTester:
    ...
    def writeOutputFile(self):
        # Generate comprehensive test results report with clear pass/fail status
        try:
            with open(self.outputFile, 'w') as f:
                ...
                if 'temperatureStatus' in self.testResults:
                    ...
                    if tempStatus.get('sensorDetails'):
                        f.write(f"  SENSOR BREAKDOWN:\n")
                        for sensor, details in tempStatus['sensorDetails'].items():
                            f.write(f"    {sensor}:\n")
                            f.write(f"      Max: {details['max']}°C ({details['maxStatus']})\n")
                            f.write(f"      Avg: {details['avg']}°C ({details['avgStatus']})\n")
                            f.write(f"      Min: {details['min']}°C\n")
                f.write("\n")
